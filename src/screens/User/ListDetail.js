...
import { Entypo, MaterialCommunityIcons, Ionicons, Foundation, FontAwesome5 } from "@expo/vector-icons";
                  ...
                  />
                    <View style={styles.bookbox}>
                        ...
                        <View style={{display:'flex',flexDirection:'row',marginBottom:20}}>
                          <Text style={{marginRight:20}}><FontAwesome5 name='calendar'   size={28} color="#000"/></Text>
                          <Text style={{color:'#000', fontSize:20}}>   Date </Text>
                        </View>


                        <View style={{display:'flex',flexDirection:'row',marginBottom:20}}>
                          <Text style={{marginRight:20}}><Ionicons name='ios-time'   size={28} color="#000" style={{marginRight:12}}/></Text>
                          <Text style={{color:'#000', fontSize:20}}>   Time</Text>
                        </View>
                         
                        
                      <View style={{display:'flex',flexDirection:'row',marginBottom:20}}>
                        <View style={{backgroundColor:'#bebebe',padding:6,marginRight:20,}}><Text style={{color:'#fff'}}>09:00-13:00</Text></View>
                        <View style={{backgroundColor:'#bebebe',padding:6}}><Text style={{color:'#fff'}}>09:00-13:00</Text></View>
                     </View>
                    <Button onPress={handleBook} full style={styles.buttons}>
                    <Text style={{position:'absolute', left:10}}><Ionicons name="ios-hand" style={{position:'absolute'}} size={30} color={'#fff'}/></Text>
